...
RuneReaderVoice.defaultConfig = {
    ...
    -- RuneReader Barcode identity side-channel
    RrvbEnabled      = true,       -- display RuneReader Barcode GUID/name side-channel
    RrvbFontSize     = 20,         -- barcode font size; larger = easier scan
    RrvbGuidPosition = nil,        -- saved GUID frame anchor
    RrvbNamePosition = nil,        -- saved Name frame anchor
